...
export const getPlantsEdibleQueryTwo = (queryText) => {
  ...
  return axios.get('https://inspiring-bhabha-97906e.netlify.app/.netlify/functions/apiGetPlantsQueryEdible', { params: { queryText: queryText } })
}

export const getSinglePlant = (slug) => {
  return axios.get('https://inspiring-bhabha-97906e.netlify.app/.netlify/functions/apiGetSinglePlant', { params: { slug: slug } } )
}